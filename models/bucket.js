module.exports = class Bucket {
    ...
    static create(bucketName, bucketLimit, bucketTotal, wishList){
        const bucket = new Bucket(bucketName, bucketLimit)
        bucket.bucketTotal = bucketTotal
        bucket.wishList = wishList.map(Donee.create)
    }
